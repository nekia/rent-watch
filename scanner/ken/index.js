...
const nats_subject_roomurl = process.env.NATS_SUBJECT_ROOMURL ? process.env.NATS_SUBJECT_ROOMURL : "room-ken-tky-rent";
...
getFloorLevel = async (page) => {
  // e.g. 3階 / 地上4階 地下1階建て
  const floorLevel = await page.$('//h2[text()="物件詳細"]/parent::div/parent::div/following-sibling::div//th[text()="階建 / 所在階"]/following-sibling::td')
